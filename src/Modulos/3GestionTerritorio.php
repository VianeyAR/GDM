...
<img class="card-img-top" src="../../assets/img/GestionTerritorio.png"
			...
			<div class="card-body">
				...
				<form method="POST" enctype="multipart/form-data">
					...
					$labels311 = [
						...
						<div class="btn-group" role="group" aria-label="">
								<button type="submit" name="311" value="" class="btn btn-success" <?php if ($botonDeshabilitado1) echo "disabled"; ?>>Evaluar</button>
							</div>
						...
						<div class="btn-group" role="group" aria-label="">
								<button type="submit" name="312" value="" class="btn btn-success" <?php if ($botonDeshabilitado2) echo "disabled"; ?>>Evaluar</button>
							</div>
					...
					<div class="btn-group" role="group" aria-label="">
							<button type="submit" name="313" value="" class="btn btn-success" <?php if ($botonDeshabilitado3) echo "disabled"; ?>>Evaluar</button>
						</div>
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<form method="POST" enctype="multipart/form-data">
						...
						<div class="btn-group" role="group" aria-label="">
							<button type="submit" name="314" value="Agregar" class="btn btn-success" <?php if ($botonDeshabilitado4) echo "disabled"; ?>>Evaluar</button>
						</div>
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<form method="POST" enctype="multipart/form-data">
					...
					<div class="btn-group" role="group" aria-label="">
							<button type="submit" name="321" value="" class="btn btn-success" <?php if ($botonDeshabilitado5) echo "disabled"; ?>>Evaluar</button>
						</div>
					...
					<div class="btn-group" role="group" aria-label="">
							<button type="submit" name="322" value="" class="btn btn-success" <?php if ($botonDeshabilitado6) echo "disabled"; ?>>Evaluar</button>
						</div>
						...
						<div class="btn-group" role="group" aria-label="">
								<button type="submit" name="323" value="" class="btn btn-success" <?php if ($botonDeshabilitado7) echo "disabled"; ?>>Evaluar</button>
							</div>
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<form method="POST" enctype="multipart/form-data">
						...
						<div class="btn-group" role="group" aria-label="">
							<button type="submit" name="324" value="Agregar" class="btn btn-success" <?php if ($botonDeshabilitado8) echo "disabled"; ?>>Evaluar</button>
						</div>
			...
			<div class="card-body">
				...
				<form method="POST" enctype="multipart/form-data">
					...
					<?php
						...
						<div class="btn-group" role="group" aria-label="">
								<button type="submit" name="331" value="" class="btn btn-success" <?php if ($botonDeshabilitado9) echo "disabled"; ?>>Evaluar</button>
							</div>
						...
						<div class="btn-group" role="group" aria-label="">
								<button type="submit" name="332" value="" class="btn btn-success" <?php if ($botonDeshabilitado10) echo "disabled"; ?>>Evaluar</button>
							</div>
						...
						<div class="btn-group" role="group" aria-label="">
								<button type="submit" name="333" value="" class="btn btn-success" <?php if ($botonDeshabilitado11) echo "disabled"; ?>>Evaluar</button>
							</div>
						...
						<?php
							...
							<div class="btn-group" role="group" aria-label="">
									<button type="submit" name="334" value="" class="btn btn-success" <?php if ($botonDeshabilitado12) echo "disabled"; ?>>Evaluar</button>
								</div>
						...
						<div class="btn-group" role="group" aria-label="">
								<button type="submit" name="335" value="" class="btn btn-success" <?php if ($botonDeshabilitado13) echo "disabled"; ?>>Evaluar</button>
							</div>
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<div class="form-group">
							...
							<div class="btn-group" role="group" aria-label="">
								<button type="submit" name="336" value="Agregar" class="btn btn-success" <?php if ($botonDeshabilitado14) echo "disabled"; ?>>Evaluar</button>
							</div>
				...
				<form method="POST" enctype="multipart/form-data">
					...
					$labels341 = [
						...
						'f) Lista de espacios públicos con infraestructura verde instalados en el municipio.'
							...
							<div class="btn-group" role="group" aria-label="">
									<button type="submit" name="341" value="" class="btn btn-success" <?php if ($botonDeshabilitado15) echo "disabled"; ?>>Evaluar</button>
								</div>
					...
					<div class="btn-group" role="group" aria-label="">
							<button type="submit" name="342" value="" class="btn btn-success" <?php if ($botonDeshabilitado16) echo "disabled"; ?>>Evaluar</button>
						</div>
					...
					<div class="btn-group" role="group" aria-label="">
							<button type="submit" name="343" value="" class="btn btn-success" <?php if ($botonDeshabilitado17) echo "disabled"; ?>>Evaluar</button>
						</div>
